  ...
  return (
    <header className="bg-blue-50 text-blue-900 sticky top-0 z-50 shadow-sm">
      <nav className="container mx-auto px-6 lg:px-12 py-4 flex items-center justify-between">
        {/* Logo */}
        <Link href="/" className="text-2xl font-bold tracking-wide text-blue-900">
          MedyoCare
        </Link>
        ...
        {user ? (
          ...
          <Link
            href="/login"
            className="hidden md:block bg-teal-600 hover:bg-teal-700 text-white px-5 py-2 rounded-lg transition"
          >
            Login
          </Link>
        )}
      ...
      {open && (
        <div className="md:hidden bg-white py-4 px-6 space-y-4 shadow-inner rounded-b-lg">
          ...
          {user ? (
            ...
            <Link
              href="/login"
              className="inline-block bg-teal-600 hover:bg-teal-700 text-white px-5 py-2 rounded-lg transition w-full text-center"
            >
              Login
            </Link>
          )}
