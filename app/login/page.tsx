  ...
  return (
    <div className="min-h-screen bg-blue-50 flex items-center justify-center px-4">
      <div className="bg-white shadow-2xl rounded-2xl overflow-hidden w-full max-w-4xl grid grid-cols-1 md:grid-cols-2">
        ...
        <div
          className="relative text-white p-10 flex flex-col items-center justify-center"
          style={{
        ...
        >
          <div className="absolute inset-0 bg-blue-900/90 rounded-l-2xl"></div>
        ...
        {/* RIGHT COLUMN */}
        <div className="p-10">
          <h1 className="text-2xl font-bold mb-6 text-blue-900 text-center">Student Login</h1>
